...
const Aboutus = () => {
    return (
        <div>
            ...
            <section className="bg-white dark:bg-gray-dark py-14 md:py-20">
                <div className="container">
                    <div className="grid-cols-3 lg:grid">
                        <div className="col-span-2 lg:ltr:pr-20 lg:rtl:pl-20" data-aos="fade-right" data-aos-duration="1000">
                            <div className="heading flex flex-col-reverse mb-0 text-center ltr:lg:text-left rtl:lg:text-right">
                                <h4 className="font-playfair text-3xl">Prestigio y trayectoria</h4>
                                <h5 className="font-montserrat text-lg">Nuestra fortaleza</h5>
                            </div>
                            <div className="my-10 grid gap-10 text-lg font-semibold ltr:text-left rtl:text-right sm:grid-cols-2 md:my-14">
            ...
            <section className="py-14 lg:py-20 bg-meliora-2 dark:bg-none dark:bg-gray-black">
                <CounterComponent subtitle="Más de una década contigo" title="Nuestra experiencia en cifras" />
            </section>

            <section className="py-14 lg:py-20 sm:px-5 bg-white dark:bg-none dark:bg-gray-dark">
