...
const Contactus = () => {
    return (
        <div>
            ...
            <section className="bg-[#efefef] py-10 dark:bg-[#101010] lg:py-[50px]">
                <div className="container">
                    <div className="heading text-center">
                        <h4 className="font-playfair text-3xl sm:!leading-[50px]">Datos de Contacto</h4>
                    </div>
                    <div className="mb-10 grid grid-cols-1 gap-[30px] lg:grid-cols-3">
                        <WidgetContact props={sections.contact.phone} />
                        <WidgetContact props={sections.contact.email} />
                        <div
                            className="rounded-[32px] bg-white px-4 py-6 hover:bg-secondary/20 dark:bg-gray-dark md:w-full md:p-7"
                            data-aos="fade-up"
