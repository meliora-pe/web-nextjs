    ...
    return (
        <div className="container">
            <div className="heading flex flex-col-reverse text-center">
                <h4 className="font-playfair">{props.title}</h4>
                <h6 className="font-montserrat">{props.subtitle}</h6>
            </div>
            <div className="grid gap-[30px] sm:grid-cols-2 lg:grid-cols-4">
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex items-baseline rounded-3xl bg-white py-8 px-6 dark:border-transparent dark:bg-gray-dark">
                        <div>
                            <img src="/assets/images/experiencia.png" alt="icono de experiencia" className="w-[26px] h-[26px]"/>
                        </div>
                        <div className="ltr:pl-4 rtl:pr-4">
                            <h4 className="pb-2.5 text-4xl font-black leading-none transition dark:text-white">
                                <CountUp start={0} end={11} duration={4} suffix=""></CountUp>
                            </h4>
                            <span className="font-bold text-black transition dark:text-gray">Años</span>
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex items-baseline rounded-3xl bg-white py-8 px-6 dark:border-transparent dark:bg-gray-dark">
                        ...
                        <div className="ltr:pl-4 rtl:pr-4">
                            <h4 className="pb-2.5 text-4xl font-black leading-none transition dark:text-white">
                                <CountUp start={0} end={6} duration={4} suffix=""></CountUp>
                            </h4>
                            <span className="font-bold text-black transition dark:text-gray">Profesionales</span>
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex items-baseline rounded-3xl bg-white py-8 px-6 dark:border-transparent dark:bg-gray-dark">
                        ...
                        <div className="ltr:pl-4 rtl:pr-4">
                            ...
                            <span className="font-bold text-black transition dark:text-gray">Sonrisas saludables</span>
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="group flex items-baseline rounded-3xl bg-white py-8 px-6 dark:border-transparent dark:bg-gray-dark">
                        ...
                        <div className="ltr:pl-4 rtl:pr-4">
                            <h4 className="pb-2.5 text-4xl font-black leading-none transition dark:text-white">
                                <CountUp start={0} end={8000} duration={4} suffix="+"></CountUp>{' '}
                            </h4>
                            <span className="font-bold text-black transition dark:text-gray">Tratamientos</span>
                        </div>
                    </div>
                </div>
            </div>
