...
const Testimonial = ({
    ...
    return (
        <section className={`relative bg-black py-14 dark:bg-none dark:bg-gray-dark/50 lg:py-20 ${className}`}>
            ...
            <div className="container">
                <div className={`heading text-center ${showTitle ? '' : 'hidden'}`} data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <h4 className="!text-white font-playfair text-3xl">Reconocimiento y gratitud</h4>
                </div>
                <div className={`mx-auto lg:w-11/12`} data-aos="fade-right" data-aos-duration="1000">
                    <div className="relative sm:py-12 md:py-0">
                                                ...
                                                <div className="col-span-2">
                                                    <div className="relative rounded-3xl bg-white/[0.3] p-6">
                                                        ...
                                                        <div className="mt-12">
                                                            ...
                                                            <h6 className="text-sm font-bold italic">{"Hace "}{feedback.time}{" meses"}</h6>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className={`bottom-0 mt-5 flex items-center justify-center gap-4 ltr:right-1/3 rtl:left-1/3 sm:absolute sm:mt-0 sm:justify-end`}>
                            <img src="/assets/images/swipe-icon.svg" alt="swipe-icon" title="swipe-icon" className="w-12 h-12 animate-ping"/>
                        </div>
                    </div>
                </div>
            </div>
